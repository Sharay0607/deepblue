...
public class AnimalServiceImpl implements AnimalService {
    ...
    private static final Set<RescueStatus> STATUSES_THAT_CAN_RECEIVE_TREATMENT =
    ...
    public boolean canReceiveTreatment(String animalCode) {
        ...
        return STATUSES_THAT_CAN_RECEIVE_TREATMENT.contains(animal.getRescueCase().getStatus());
    }
}
